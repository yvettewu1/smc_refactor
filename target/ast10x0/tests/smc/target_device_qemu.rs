...
//! 6. **from_spi path** — initialize SPI1 and build facade with `from_spi`.
//!    QEMU does not reliably back the SPI1 flash aperture, so this target
//!    validates construction/capacity only for the SPI constructor path.
